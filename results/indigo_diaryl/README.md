# Results Guide — indigo_diaryl

This folder contains the **regression outputs for the `indigo_diaryl` case**.

## Quick start: what to open first

1) **Top 5 best models (recommended entry point)**  
   - `indigo_diaryl_top5_models.csv`  
   What you get:
...
- `indigo_diaryl_Regression_Plot.html`  
...
- **Top model metrics** from `indigo_diaryl_top5_models.csv` (row 1)  
