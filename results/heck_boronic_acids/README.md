# Results Guide — heck_boronic_acids

This folder contains the **regression outputs for the `heck_boronic_acids` case**.

## Quick start: what to open first

1) **Top 5 best models (recommended entry point)**  
   - `heck_boronic_acids_top5_models.csv`  
   What you get:
...
- `heck_boronic_acids_Regression_Plot.html`  
...
- **Top model metrics** from `heck_boronic_acids_top5_models.csv` (row 1)  
