# Results Guide — indigo_aryl_alkyl

This folder contains the **regression outputs for the `indigo_aryl_alkyl` case**.

## Quick start: what to open first

1) **Top 5 best models (recommended entry point)**  
   - `indigo_aryl_alkyl_top5_models.csv`  
   What you get:
...
- `indigo_aryl_alkyl_Regression_Plot.html`  
...
- **Top model metrics** from `indigo_aryl_alkyl_top5_models.csv` (row 1)  
